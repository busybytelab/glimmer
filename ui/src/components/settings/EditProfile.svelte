...
<div class="py-6">
	<div class="container mx-auto px-4 sm:px-6 lg:px-8">
		<h1 class="text-2xl font-semibold text-gray-900 dark:text-white mb-6">Edit Profile</h1>
	</div>
	...
	<div class="container mx-auto px-4 sm:px-6 lg:px-8">
		<FormSection title="Profile Information" description="Update your personal details">
			<form on:submit|preventDefault={handleSubmit} class="p-4">
				...
				<div class="px-4 py-3 bg-gray-50 dark:bg-gray-700 text-right sm:px-6 mt-4 -mx-4 -mb-4 border-t border-gray-200 dark:border-gray-600">
					<FormButton 
						type="submit" 
						{isLoading}
						loadingText="Saving..."
